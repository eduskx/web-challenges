...
let fruits = ["apple", "banana", "grapefruit"];
fruits[0] = "mango";
console.log(fruits);
...
let petsWithPush = ["dog", "cat", "rabbit"];
...
let fruitsWithPop = ["apple", "banana", "mango"];
fruitsWithPop.pop();
...
let unshiftedPets = ["dog", "cat", "rabbit"];
...
let shiftedFruits = ["apple", "banana", "mango"];
shiftedFruits.shift();
